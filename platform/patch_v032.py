...
t = t.replace("versionCode = ver.V1", "versionCode = 32")
t = t.replace("versionName = ver.V2", "versionName = '0.32.0'")
...
(root / 'NV_ENGINE_ATTRIBUTION.txt').write_text(
    'NV v0.32 uses Organic Maps/OpenStreetMap. Smart online services are user-controllable; ETA is smoothed and shows a no-live-traffic range; metro station pairs are evaluated for connectivity; map downloads require explicit consent; no live traffic, train, taxi availability, or price data is fabricated.\n',
    encoding='utf-8')
...
print('NV v0.32 user-friendly integration applied')
